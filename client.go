...
// APIClient manages communication with the Geo API API vv0.1
...
type APIClient struct {
	...
	ShapeCollectionApi *ShapeCollectionApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ShapeCollectionApi = (*ShapeCollectionApiService)(&c.common)
